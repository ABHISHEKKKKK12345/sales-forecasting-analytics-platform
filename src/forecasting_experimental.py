    ...
    def generate(
        ...
        if optionals:
            story.append(Paragraph(
                f"<b>Advanced Models available:</b> {', '.join(optionals)}", S["Small"]))
...
class ExcelReportGenerator:
    ...
    def _sheet_summary(self, wb: Any, analysis: SalesAnalysis) -> None:
        ...
        kpis = [
            ...
            ("Total Forecast Revenue",     f"{sym}{ens.predictions.sum():,.0f}"),
            ("Advanced Models",         ", ".join(optionals) if optionals else "None installed"),
...
class SalesForecastApp:
    ...
    def _build_models_card(self, parent: "tk.Frame") -> None:
        ...
        tk.Label(body, text="  🆕  Advanced Models (optional — install separately)",
...
def main() -> None:
    if _IMPORT_ERROR:
        ...
        messagebox.showerror(
            ...
            "Install optional models (any or all):\n\n"
